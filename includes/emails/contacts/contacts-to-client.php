...
<head>
  ...
  <title>Copiando net - Digitalización de documentos</title>
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="1" width="600" style="margin: auto;border: solid 1px #c8c8c8; background-color: #fefefe;" class="email-container">
      ...
      <tr style="background-color: #fefefe;">
        <td style="padding: 40px; padding-top: 0px;">
          ...
          <h2 class="fallback-font" style="margin: 0 0 20px 0; padding-top: 40px; font-family: 'Montserrat', sans-serif; font-size: 22px; line-height: 32px; color: #ff0000; text-align: center; font-weight: 700; text-transform: uppercase;">
            <strong>NUEVO CONTACTO DESDE {name_landing}</strong>
          </h2>
      ...
      <tr style="background-color: #ff0000;">
        <td style="background-color: #ff0000; text-align: center; padding: 40px;">
